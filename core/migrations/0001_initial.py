...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_log', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cvn.UserProfile'])),
    ...
    models = {
        ...
        u'core.log': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cvn.UserProfile']"})
        },
        u'cvn.userprofile': {
