...
class SituacionProfesional(models.Model):
    ...
    # Campos recomendados
    nombre_de_la_entidad = models.CharField(u'Nombre de la entidad',
                                            max_length=128,
                                            blank=True, null=True)
    tipo_de_entidad = models.CharField(u'Tipo de entidad',
                                       max_length=32,
                                       blank=True, null=True)
    categoria_or_puesto = models.CharField(u'Categoría/puesto o cargo',
                                           max_length=32,
                                           blank=True, null=True)
    fecha_de_inicio = models.DateField(u'Fecha de inicio',
                                       blank=True, null=True)

    modalidad_del_contrato = models.CharField(u'Modalidad del contrato',
                                              max_length=32,
                                              blank=True, null=True)
    ...
    tipo_de_dedicacion = models.CharField(u'Tipo de dedicación',
                                          max_length=16, blank=True, null=True)
    ...
    facultad_or_escuela = models.CharField(u'Facultad, escuela, etc.',
                                           max_length=64,
                                           blank=True, null=True)
    departamento_or_servicio = models.CharField(u'Departamento o servicio',
                                                max_length=64,
                                                blank=True, null=True)

    ciudad_de_trabajo = models.CharField(u'Ciudad de Trabajo',
                                         max_length=64, blank=True, null=True)
    ...
    telefono_fijo_num = models.PositiveIntegerField(u'Número',
                                                    blank=True, null=True)
    telefono_fijo_ext = models.PositiveIntegerField(u'Extensión',
                                                    blank=True, null=True)

    telefono_fax_cod = models.CharField(u'Código internacional',
                                        max_length=12, blank=True, null=True)
    telefono_fax_num = models.PositiveIntegerField(u'Número',
                                                   blank=True, null=True)
    telefono_fax_ext = models.PositiveIntegerField(u'Extensión',
                                                   blank=True, null=True)
    ...
    def __unicode__(self):
        return u"%s, %s en %s" % (self.usuario,
                                  self.categoria_or_puesto,
                                  self.nombre_de_la_entidad)
...
class Produccion(models.Model):
    ...
    # Campos recomendados
    indice_h = models.CharField(u'Índice H',
