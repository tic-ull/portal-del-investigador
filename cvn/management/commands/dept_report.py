...
class Command(BaseCommand):
    help = u'Genera un pdf con los datos de un departamento. Usa una BBDD congelada accesible por SQL'
    ...
    def test_lista_investigadores(self):
        ...
        informe = Informe_pdf(2012, {"nombre":"PSICOLOGÍA SOCIAL COGNITIVA"}, investigadores,[], [])
        informe.go()
    ...
    def create_report(self):
        ...
        informe = Informe_pdf(self.YEAR, datos_basicos, investigadores, produccion, actividad)
        informe.go()
