...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cvn_usuario', 'direccion', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'Usuario.resto_direccion'
        db.alter_column(u'cvn_usuario', 'resto_direccion', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

    def backwards(self, orm):

        # Changing field 'Usuario.direccion'
        db.alter_column(u'cvn_usuario', 'direccion', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'Usuario.resto_direccion'
        db.alter_column(u'cvn_usuario', 'resto_direccion', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))
