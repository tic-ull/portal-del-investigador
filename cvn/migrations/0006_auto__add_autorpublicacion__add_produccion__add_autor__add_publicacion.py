...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AutorPublicacion'
        db.create_table(u'cvn_autorpublicacion', (
            (u'autor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cvn.Autor'], unique=True, primary_key=True)),
            ('publicacion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cvn.Publicacion'])),
        ))
        db.send_create_signal(u'cvn', ['AutorPublicacion'])
        ...
        # Adding model 'Autor'
        db.create_table(u'cvn_autor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('firma', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
        ...
        db.send_create_signal(u'cvn', ['Autor'])
        ...
        db.create_table(u'cvn_publicacion', (
            ...
            ('fecha', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('titulo_publicacion', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('tipo_de_soporte', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('nombre_publicacion', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ...
            ('en_calidad_de', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ...
            ('coleccion', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ...
            ('fuente_de_impacto', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('categoria', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('indice_de_impacto', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('posicion', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('num_revistas_catoria', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('revista_25', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True)),
            ('fuente_de_citas', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('citas', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('publicacion_relevante', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True)),
            ('resenyas_en_revista', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('filtro', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
    ...
    def backwards(self, orm):
        # Deleting model 'AutorPublicacion'
        db.delete_table(u'cvn_autorpublicacion')

        # Deleting model 'Produccion'
        db.delete_table(u'cvn_produccion')

        # Deleting model 'Autor'
        db.delete_table(u'cvn_autor')
