...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Usuario.telefono_fijo_cod'
        db.alter_column(u'cvn_usuario', 'telefono_fijo_cod', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'Usuario.telefono_fax_ext'
        db.alter_column(u'cvn_usuario', 'telefono_fax_ext', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'Usuario.telefono_movil_ext'
        db.alter_column(u'cvn_usuario', 'telefono_movil_ext', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'Usuario.telefono_movil_cod'
        db.alter_column(u'cvn_usuario', 'telefono_movil_cod', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'Usuario.telefono_fijo_ext'
        db.alter_column(u'cvn_usuario', 'telefono_fijo_ext', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'Usuario.telefono_fax_cod'
        db.alter_column(u'cvn_usuario', 'telefono_fax_cod', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

    def backwards(self, orm):

        # Changing field 'Usuario.telefono_fijo_cod'
        db.alter_column(u'cvn_usuario', 'telefono_fijo_cod', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

        # Changing field 'Usuario.telefono_fax_ext'
        db.alter_column(u'cvn_usuario', 'telefono_fax_ext', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))

        # Changing field 'Usuario.telefono_movil_ext'
        db.alter_column(u'cvn_usuario', 'telefono_movil_ext', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))

        # Changing field 'Usuario.telefono_movil_cod'
        db.alter_column(u'cvn_usuario', 'telefono_movil_cod', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

        # Changing field 'Usuario.telefono_fijo_ext'
        db.alter_column(u'cvn_usuario', 'telefono_fijo_ext', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))

        # Changing field 'Usuario.telefono_fax_cod'
        db.alter_column(u'cvn_usuario', 'telefono_fax_cod', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))
