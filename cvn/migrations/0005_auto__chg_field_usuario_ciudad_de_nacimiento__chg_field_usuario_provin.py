...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Usuario.ciudad_de_nacimiento'
        db.alter_column(u'cvn_usuario', 'ciudad_de_nacimiento', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Usuario.provincia'
        db.alter_column(u'cvn_usuario', 'provincia', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Usuario.comunidad'
        db.alter_column(u'cvn_usuario', 'comunidad', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Usuario.comunidad_nacimiento'
        db.alter_column(u'cvn_usuario', 'comunidad_nacimiento', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Usuario.nacionalidad'
        db.alter_column(u'cvn_usuario', 'nacionalidad', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Usuario.ciudad_de_contacto'
        db.alter_column(u'cvn_usuario', 'ciudad_de_contacto', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Usuario.pais_de_nacimiento'
        db.alter_column(u'cvn_usuario', 'pais_de_nacimiento', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Usuario.pais_de_contacto'
        db.alter_column(u'cvn_usuario', 'pais_de_contacto', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # Changing field 'Usuario.ciudad_de_nacimiento'
        db.alter_column(u'cvn_usuario', 'ciudad_de_nacimiento', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Usuario.provincia'
        db.alter_column(u'cvn_usuario', 'provincia', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Usuario.comunidad'
        db.alter_column(u'cvn_usuario', 'comunidad', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Usuario.comunidad_nacimiento'
        db.alter_column(u'cvn_usuario', 'comunidad_nacimiento', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Usuario.nacionalidad'
        db.alter_column(u'cvn_usuario', 'nacionalidad', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Usuario.ciudad_de_contacto'
        db.alter_column(u'cvn_usuario', 'ciudad_de_contacto', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Usuario.pais_de_nacimiento'
        db.alter_column(u'cvn_usuario', 'pais_de_nacimiento', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Usuario.pais_de_contacto'
        db.alter_column(u'cvn_usuario', 'pais_de_contacto', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
